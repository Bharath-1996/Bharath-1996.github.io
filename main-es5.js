(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChatComponent = /** @class */ (function () {
                function ChatComponent(af, afauth, service, fr, empservice) {
                    var _this = this;
                    this.af = af;
                    this.afauth = afauth;
                    ...
                    this.msgVal = '';
                    this.af.collection('messages').valueChanges().subscribe(function (values) { return _this.count = (values.length + 1).toString(); });
                    this.items = af.collection('messages');
                    this.name = this.afauth.auth.currentUser.email;
                }
                ChatComponent.prototype.chatsend = function (chatmsg) {
                    var _this = this;
                    ///console.log("length of chats is "+this.count);
                    var timestamp = firebase__WEBPACK_IMPORTED_MODULE_5__["firestore"].FieldValue.serverTimestamp;
                    var data = {};
                    this.empservice.getemployeebyid().then(function (val) {
                        if (val.fullName.trim) {
                            _this.empname = val.email.substring(0, val.email.indexOf('@'));
                        }
                        else {
                            _this.empname = val.fullName;
                        }
                    });
                ...
                ChatComponent.prototype.ngOnInit = function () {
                    ...
                    this.service.getmessages().subscribe(function (actionArray) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChatService = /** @class */ (function () {
                ...
                ChatService.prototype.talk = function () {
                    this.client.textRequest('Who are you!').then(function (res) { return console.log(res); });
                };
                return ChatService;
            }());
            /***/ 
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EmployeeListComponent = /** @class */ (function () {
                function EmployeeListComponent(service, firestore, toaster) {
                    this.service = service;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EmployeeListsComponent = /** @class */ (function () {
                function EmployeeListsComponent(service, afauth, dialog) {
                    this.service = service;
                    this.afauth = afauth;
                    this.dialog = dialog;
                ...
                EmployeeListsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.showSpinner = true;
                    this.service.getEmployees().subscribe(function (actionArray) {
                        var array = actionArray.map(function (item) {
                            return Object.assign({ id: item.payload.doc.id }, item.payload.doc.data());
                        });
                        _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](array);
                        _this.dataSource.sort = _this.sort;
                        _this.dataSource.paginator = _this.paginator;
                        _this.showSpinner = false;
                    });
                };
                EmployeeListsComponent.prototype.searchclear = function () {
                    this.searchkey = '';
                    this.applyFilter();
                };
                EmployeeListsComponent.prototype.applyFilter = function () {
                    this.dataSource.filter = this.searchkey.trim().toLowerCase();
                    if (this.dataSource.paginator) {
                        this.dataSource.paginator.firstPage();
                    }
                };
                EmployeeListsComponent.prototype.onAdd = function () {
                ...
                EmployeeListsComponent.prototype.onEdit = function (emp) {
                    // const dialogConfig=new MatDialogConfig();
                    // dialogConfig.disableClose=false;
                    // dialogConfig.autoFocus=true;
                    // dialogConfig.width="70%";
                    // this.dialog.open(EmployeeComponent,dialogConfig);
                    var dialogRef = this.dialog.open(_employee_profile_employee_profile_component__WEBPACK_IMPORTED_MODULE_8__["EmployeeProfileComponent"], {
                        width: '70%',
                        data: {
                            name: emp.fullName,
                            empCode: emp.empCode,
                ...
                return EmployeeListsComponent;
            }());
            EmployeeListsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EmployeeProfileComponent = /** @class */ (function () {
                function EmployeeProfileComponent(dialogRef, data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EmployeeComponent = /** @class */ (function () {
                function EmployeeComponent(service, firestore, toastr, afAuth, storage, imgservice) {
                    this.service = service;
                    this.firestore = firestore;
                    this.toastr = toastr;
                    this.afAuth = afAuth;
                ...
                EmployeeComponent.prototype.populateforms = function (emp) {
                ...
                EmployeeComponent.prototype.showpreview = function (event) {
                    var _this = this;
                ...
                EmployeeComponent.prototype.uploadpic = function (formValue) {
                    var _this = this;
                    this.issubmitted = true;
                    if (this.formTemplate.valid) {
                        var filePath = 'images/' + this.afAuth.auth.currentUser.uid;
                        var fileRef_1 = this.storage.ref(filePath);
                        this.storage.upload(filePath, this.selectedimage).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["finalize"])(function () {
                            fileRef_1.getDownloadURL().subscribe(function (url) {
                                formValue['imageUrl'] = url;
                                formValue['uid'] = _this.afAuth.auth.currentUser.uid;
                                _this.firestore.collection('imagedetails').add(formValue);
                                _this.uploadformreset();
                            });
                        })).subscribe();
                        //console.log(filePath);
                    }
                };
                Object.defineProperty(EmployeeComponent.prototype, "formControls", {
                    get: function () {
                ...
                EmployeeComponent.prototype.uploadformreset = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FooterComponent = /** @class */ (function () {
                ...
                FooterComponent.prototype.onAdd = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                function HeaderComponent(auth, dialog, router) {
                    this.auth = auth;
                    this.dialog = dialog;
                    this.router = router;
                }
                ...
                HeaderComponent.prototype.onAdd = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfileComponent = /** @class */ (function () {
                function ProfileComponent(service, firestore, afAuth, imgservice, storage, toaster, router) {
                    this.service = service;
                    this.firestore = firestore;
                    this.afAuth = afAuth;
                    this.imgservice = imgservice;
                ...
                ProfileComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.resetForm();
                    this.getemployeebyid().then(function (data) {
                        //console.log(data);
                        var emp = data;
                        _this.service.formData = Object.assign({}, emp);
                    });
                    this.uploadformreset();
                    this.imgservice.getImageDetailList();
                ...
                ProfileComponent.prototype.resetForm = function (form) {
                    if (form != null)
                        form.resetForm();
                    this.service.formData = {
                        id: null,
                ...
                ProfileComponent.prototype.getemployeebyid = function () {
                ...
                ProfileComponent.prototype.onEdit = function (emp) {
                    this.service.formData = Object.assign({}, emp);
                };
                ProfileComponent.prototype.showpreview = function (event) {
                    var _this = this;
                    if (event.target.files && event.target.files[0]) {
                        var reader = new FileReader();
                        reader.onload = function (e) { return _this.imgsrc = e.target.result; };
                ...
                ProfileComponent.prototype.uploadpic = function (formValue) {
                    var _this = this;
                    this.showSpinner = true;
                    this.issubmitted = true;
                    if (this.formTemplate.valid) {
                        var filePath = 'images/' + this.afAuth.auth.currentUser.uid;
                        var fileRef_2 = this.storage.ref(filePath);
                        this.storage.upload(filePath, this.selectedimage).snapshotChanges().pipe(Object(rxjs_internal_operators_finalize__WEBPACK_IMPORTED_MODULE_7__["finalize"])(function () {
                            fileRef_2.getDownloadURL().subscribe(function (url) {
                                formValue['imageUrl'] = url;
                                formValue['uid'] = _this.afAuth.auth.currentUser.uid;
                                _this.finalimaageurl = url;
                                _this.service.formData.imageUrl = url;
                ...
                ProfileComponent.prototype.uploadformreset = function () {
                    this.showSpinner = false;
                    this.tickstatus = true;
                    this.formTemplate.reset();
                    this.formTemplate.setValue({
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignInComponent = /** @class */ (function () {
                function SignInComponent(auth, afauth, router) {
                    this.auth = auth;
                    this.afauth = afauth;
                    this.router = router;
                    this.showSpinner = true;
                ...
                SignInComponent.prototype.navigate = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignUpComponent = /** @class */ (function () {
                function SignUpComponent(auth, firestore, fb, afauth, router) {
                    this.auth = auth;
                    this.firestore = firestore;
                    this.fb = fb;
                    this.afauth = afauth;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                function AuthService(afAuth, router, toaster, firestore) {
                    this.afAuth = afAuth;
                    this.router = router;
                    this.toaster = toaster;
                    this.firestore = firestore;
                ...
                AuthService.prototype.signup = function (email, password) {
                    ...
                    this.afAuth.auth.createUserWithEmailAndPassword(email, password).then(function (value) {
                        _this.toaster.success('Registered Successfully, you need to verify your email before login, check your email inbox/spam/promotions folders', 'Emp.Register', options);
                        //this.toaster.show('You need to verify the email!...','Verify Email',options);
                        _this.updatetable(email);
                        ...
                        if (errorCode === 'auth/email-already-in-use') {
                            ...
                            _this.toaster.warning('This email ID already used by someone else!..', 'Error', options);
                            _this.router.navigate(['sign-up']);
                            return;
                        }
                        _this.toaster.warning('something went wrong!..', 'Error', options);
                        _this.router.navigate(['sign-up']);
                    });
                };
                AuthService.prototype.updatetable = function (email) {
                    var data = {};
                    data['empCode'] = '';
                    data['fullName'] = '';
                    data['mobile'] = '';
                ...
                AuthService.prototype.login = function (email, password) {
                    ...
                    this.afAuth.auth.signInWithEmailAndPassword(email, password).then(function (value) {
                        if (value.user.emailVerified == true) {
                            sessionStorage.setItem('token', value.user.uid);
                            _this.toaster.success('Login Successfully', 'Emp.Login');
                            _this.router.navigate(['main']);
                        }
                        else {
                            _this.toaster.warning('Your email is not verified, please verify', 'Email Verify', options);
                            _this.SendVerificationMail();
                            _this.router.navigate(['sign-in']);
                        }
                    }).catch(function (err) {
                        ...
                        if (errorCode === 'auth/user-not-found') {
                            // Call function X to sign user in instead
                            _this.toaster.warning('Account does not exist, Please Register!..', 'Error', options);
                            _this.router.navigate(['sign-up']);
                            return;
                        }
                        _this.toaster.warning('something went wrong!..', 'Error', options);
                ...
                AuthService.prototype.resetpassword = function (email) {
                    ...
                    return this.afAuth.auth.sendPasswordResetEmail(email)
                        .then(function () {
                        _this.toaster.success('Password reset link is sent to your email, please check!..', 'Reset Password', options);
                        _this.router.navigate(['sign-in']);
                    });
                };
                return AuthService;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EmployeeService = /** @class */ (function () {
                function EmployeeService(firestore, afauth) {
                    this.firestore = firestore;
                    this.afauth = afauth;
                }
                ...
                EmployeeService.prototype.getmessages = function () {
                    //return this.firestore.collection('messages').snapshotChanges();
                    return this.firestore.collection('messages', function (ref) { return ref.orderBy('createdAt').limitToLast(10); }).snapshotChanges();
                };
                EmployeeService.prototype.getEmployeesbyid = function () {
                    return this.firestore.collection('employees').doc('3OU7Hd92dwd9zBCS7Lanl82645k2').snapshotChanges();
                };
                EmployeeService.prototype.getemployeebyid = function () {
                    return this.firestore.collection('employees').doc(this.afauth.auth.currentUser.uid).ref.get()
                        .then(function (doc) {
                        return doc.data();
                    });
                ...
                EmployeeService.prototype.populateform = function (emp) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./auth.service */ "./src/app/shared/auth.service.ts");
            var IsloggedinauthGuard = /** @class */ (function () {
                function IsloggedinauthGuard(authService, router) {
                    this.authService = authService;
                    this.router = router;
                }
                IsloggedinauthGuard.prototype.canActivate = function () {
                    if (!sessionStorage.getItem('token')) {
                ...
                return IsloggedinauthGuard;
            }());
            IsloggedinauthGuard.ctorParameters = function () { return [
                { type: _auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
